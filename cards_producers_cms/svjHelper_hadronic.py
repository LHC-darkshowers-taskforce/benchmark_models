...
class svjHelper(object):
    ...
    def setModel(self,mZprime,mDark,rinv,events,com,alpha=None,lambdaHV=None):
        self.events = events
        self.com = com
    ...
    def getPythiaSettings(self):
        ...
        lines_schan += self.invisibleDecay(4900111,51)
        lines_schan += self.visibleDecay("massInsertion",4900111,51)
        lines_schan += self.invisibleDecay(4900211,51)
        lines_schan += self.visibleDecay("massInsertion",4900211,51)
        lines_schan += self.invisibleDecay(4900113,53)
        lines_schan += self.visibleDecay("democratic",4900113,53)
        lines_schan += self.invisibleDecay(4900213,53)
        lines_schan += self.visibleDecay("democratic",4900213,53)

        lines = lines_settings + lines_beams_settings + lines_schan 
...
if __name__=="__main__":
    ...
    group_alpha.add_argument("--alpha", dest="alpha", type=str, default=None, help="dark coupling strength (str or float). E.g. low, peak, high, or a number. low, peak and high refer to values of alpha impacting the final multiplicities.")
    ...
    helper = svjHelper()
    helper.setModel(args.mZprime, args.mDark, args.rinv, args.events, args.com, **helper_kwargs)
