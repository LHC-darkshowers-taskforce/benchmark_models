...
class emjHelper(object):
    ...
    def setModel(self, channel, mMed, mDark, kappa, mode='aligned', type='down', events=10000, com=13000):
        self.mMed = mMed
        self.mDark = mDark
        self.kappa0 = kappa 
        self.mode = mode
    ...
    def getOutName(self, signal=True, events=0, outpre='EMJ', part=None, sanitize=False, gridpack=False):
        _outname = outpre
...
if __name__ == "__main__":
    ...
    helper.setModel(args.channel, args.mMed, args.mDark, args.kappa, args.mode, args.type, args.events, args.com)
